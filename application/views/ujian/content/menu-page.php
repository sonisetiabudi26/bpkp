...
<div class="col-md-3 left_col menu_fixed bg-blue-gd">
  <div class="left_col scroll-view bg-blue-gd">
    <div class="navbar nav_title bg-blue-gd" style="border: 0;padding-top:10px">
    ...
    <div class="profile clearfix bg-blue-gd">
    ...
    <!-- sidebar menu -->
    <div id="sidebar-menu" class="bg-blue-gd main_menu_side hidden-print main_menu">
		<div class="menu_section">
			<div class="bg-blue-gd clearfix">&nbsp;</div>
