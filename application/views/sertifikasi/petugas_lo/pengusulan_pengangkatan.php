					...
					<div class="x_content">
							...
							<div class="row">
								...
								<div id="show_data" style="display:none;">
									<form onsubmit="procesFormandUpload(this, '<?php echo base_url('sertifikasi')."/petugas_lo/PengusulanPengangkatan/submit"; ?>')"  enctype="multipart/form-data" method="POST" id="daftar_pengusul">
							...
							<div class="row">
								<div class="panel panel-default">
									<div class="panel-heading">Unggah No Surat Pengusulan </div>
										<div class="panel-body">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<form onsubmit="procesFormandUpload(this, '<?php echo base_url('sertifikasi')."/petugas_lo/PengusulanPengangkatan/submit_nosurat"; ?>')" enctype="multipart/form-data" method="POST" id="daftar_nosurat">
...
function search(){
	 ...
	 if(nip!=''){
		$.ajax({
				type  : 'ajax',
				url   :  "<?php echo base_url('sertifikasi/petugas_lo/PengusulanPengangkatan/search/')?>/" + nip,
				async : false,
				dataType : 'json',
...
$(document).ready(function() {
  ...
  'ajax': {
    "type"   : "POST",
    "url"    : '<?php echo base_url('sertifikasi/petugas_lo/PengusulanPengangkatan/loadData/')?>',
    "dataSrc": ""
  },
  'columns': [
    {"data" : "no"},
...
function remove(obj){
	...
	$.ajax({
			type  : 'ajax',
			url   :  "<?php echo base_url('sertifikasi/petugas_lo/PengusulanPengangkatan/remove/')?>/" + obj,
			async : false,
			dataType : 'json',
			success : function(data){
				if(!data.msg){
