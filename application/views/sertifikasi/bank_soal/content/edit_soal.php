...
<div class="col-md-12">
<form  onsubmit="procesFormandUpload(this, '<?php echo base_url('sertifikasi')."/bank_soal/soal/update_soal"; ?>')" method="POST" id="editSoalForm" >
<input name='pk_soal' style="display:none" value='<?php echo $pk_soal ?>'>
<table  class="table">
	<thead>
		<tr>
		...
		<tr>
			<td>
				<div class="form-group text-default">
					...
					<input type="text" class="form-control" name="pilihan1" id="pilihan1" value="<?php echo $pilihan1 ?>"  />
				</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				<div class="form-group text-default">
					...
					<input type="text" class="form-control" name="pilihan2" id="pilihan2"  value="<?php echo $pilihan2 ?>" />
				</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				<div class="form-group text-default">
					...
					<input type="text" class="form-control" name="pilihan3" id="pilihan3" value="<?php echo $pilihan3 ?>"  />
				</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				<div class="form-group text-default">
					...
					<input type="text" class="form-control" name="pilihan4" id="pilihan4" value="<?php echo $pilihan4 ?>"  />
				</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				<div class="form-group text-default">
					...
					<input type="text" class="form-control" name="pilihan5" id="pilihan5" value="<?php echo $pilihan5 ?>"  />
				</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				<div class="form-group text-default">
					...
					<input type="text" class="form-control" name="pilihan6" id="pilihan6" value="<?php echo $pilihan6 ?>"  />
				</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				<div class="form-group text-default">
					...
					<input type="text" class="form-control" name="pilihan7" id="pilihan7"  value="<?php echo $pilihan7 ?>" />
				</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				<div class="form-group text-default">
					...
					<input type="text" class="form-control" name="pilihan8" id="pilihan8"  value="<?php echo $pilihan8 ?>" />
				</div>
			</td>
		</tr>
			...
			<td>
				<div class="form-group text-default">
					...
					<select class="form-control" name="jawaban">
						<option <?php echo ($jawaban==1?'selected':'')?> value="1">Pilihan 1</option>
						<option <?php echo ($jawaban==2?'selected':'')?>  value="2">Pilihan 2</option>
						<option <?php echo ($jawaban==3?'selected':'')?>  value="3">Pilihan 3</option>
						<option <?php echo ($jawaban==4?'selected':'')?>  value="4">Pilihan 4</option>
						<option <?php echo ($jawaban==5?'selected':'')?>  value="5">Pilihan 5</option>
						<option <?php echo ($jawaban==6?'selected':'')?>  value="6">Pilihan 6</option>
						<option <?php echo ($jawaban==7?'selected':'')?>  value="7">Pilihan 7</option>
						<option <?php echo ($jawaban==8?'selected':'')?>  value="8">Pilihan 8</option>
					</select>
				</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				<div class="form-group" id="content-list-bab-popup" >
					...
					<select class="form-control" name="parent_soal" id="select-list-kasus" value="<?php echo $parent_soal ?>" >
						<option value="0">Pilihan</option>
					</select>
				</div>
			</td>
...
// 		e.preventDefault();
// 		data = new FormData(document.getElementById('editSoalForm'));
// 		$.ajax({
// 			data : data,
// 			type : 'POST',
// 			url : "<?php //echo base_url('sertifikasi')."/bank_soal/soal/update_soal"; ?>",
// 			async: false,
// 			processData: false,
// 			contentType: false,
// 			cache:false,
