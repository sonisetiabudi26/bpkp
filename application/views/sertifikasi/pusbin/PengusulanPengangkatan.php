...
<div class="clearfix"></div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content">
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
					            <table id="pengusulanpengangkatan"  class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
												<thead>
												<tr>
													<td>NO</td>
													<td>NIP Unit Apip</td>
      ...
      $(document).ready(function() {
      		...
      		var example_table = $('#pengusulanpengangkatan').DataTable({
        'ajax': {
          "type"   : "POST",
