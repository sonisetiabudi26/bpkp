<div class="col-md-12">
<form onsubmit="uploadFileNilai(this, 'label-file')" action="<?php echo base_url('sertifikasi')."/pusbin/PerhitunganNilai/importNilai"; ?>" method="POST" enctype="multipart/form-data" id="import_nilai" >
  <div class="row">
