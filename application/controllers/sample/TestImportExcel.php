...
class TestImportExcel extends My_Controller {
	private $filename = "import_data"; // Kita tentukan nama filenya
	
	public function __construct(){
		parent::__construct();
		
		$this->load->model('sample/sampleImportExcel','sampleImportExcel');
	}
	
	public function index(){
		$data['sampleImportExcel'] = $this->sampleImportExcel->view();
