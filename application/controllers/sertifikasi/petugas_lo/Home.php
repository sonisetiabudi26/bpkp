...
class Home extends CI_Controller {
    ...
    public function index()
    {
      ...
      if(isset($fk_lookup_menu) && isset($username)){
        ...
        $data['content_page']='petugas_lo/homepage.php';
		...
		public function loadData(){
			...
			$a=1;
		        ...
		        //$dataRow['unitapip']=$kodeunitkerja;
						...
						$row[] = '<a class="btn btn-sm btn-success" href="'. base_url('sertifikasi')."/petugas_lo/Home/print_kartu/".$field->PK_REGIS_UJIAN.'" style="width:100%" ><i class="glyphicon glyphicon-print"></i> Cetak</a>';
