...
class PengusulanPengangkatan extends CI_Controller {
    ...
    public function index()
    {
      ...
      if(isset($fk_lookup_menu) && isset($username)){
        ...
        $data['content_page']='petugas_lo/pengusulan_pengangkatan.php';
		...
		public function loadData(){
			...
			foreach ($datas as $key) {
				...
				$url=base_url('sertifikasi')."/petugas_lo/PengusulanPengangkatan/vw_upload_doc/".$key->FK_STATUS_PENGUSUL_PENGANGKATAN."~".$key->PK_PENGUSUL_PENGANGKATAN."~".$key->NIP;
		...
		public function vw_upload_doc($param){
			...
			$this->load->view('sertifikasi/petugas_lo/content/modal_upload_pengusulan',$data);
			// echo 'asd';
		}
