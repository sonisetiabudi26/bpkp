...
class AngkaKredit extends My_Model
{
	...
	public function view($nip,$no_pertek){
  		...
  		$this->db->select('pertek.NO_PERTEK,pertek.DOC_PERTEK,pertek.PERTEK_DATE,pengusul_pengangkatan.NIP,pengusul_pengangkatan.NO_SURAT,pengusul_pengangkatan.CREATED_DATE  as date_pengusulan,pengusul_pengangkatan.DOC_SURAT_PENGUSULAN,angka_kredit.*');
  		$this->db->from('pertek');
