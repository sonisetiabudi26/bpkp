...
;(function ($, window, document, undefined) {
	...
	function getStepTitleTemplate(i, $step, settings) {
		...
		var $kasus = $step.find("#kasus");
		var kasusText = $kasus.html();
		var stepNumber = i + 1;
		...
		var $newStepTitle = $("" +
			"<div class='row aiia-wizard-step-title'>" +
				"<div class='col-md-12'>" +
					"<div class='col-lg-12 aiia-wizard-step-title-text'>" + kasusText + "</div>"  +
	...
	// function untuk memunculkan tombol finish
	...
	//function untuk menghapus finish ketika tombol back di click
